					...
					<div className="flex-sm-row flex-column d-flex">
						...
						<div className="col-12 col-sm-6 text-start">
							<p>
								...
								developer and software engineering graduate from the
								University of Western Ontario. I have built software
								in professional, academic and personal settings; from
								websites to video games.
							</p>
							<p>Find out more below!</p>
							<a
								className="me-2"
								href="https://github.com/chamipon"
								aria-label="Zachary Kucera Github"
							>
								<svg
									aria-hidden="true"
									focusable="false"
							...
							<a
								href="https://www.linkedin.com/in/zkucera/"
								aria-label="Zachary Kucera LinkedIn"
							>
								<svg
									aria-hidden="true"
									focusable="false"
			...
			<div id="skills" className="section dark">
				<div className="container text-center py-7">
					...
					<p>
						...
						frameworks, engines and development tools. React and Node.js
						are my go to technologies for web applications, and C# is my
				...
				<div className="container text-center py-7">
					...
					<Card
						...
						desc={[
							...
							<ul>
								<li>
									Led a small development team in the overhaul of
									Lambton College’s corporate website, from
									inception to deployment
								</li>
								<li>
									Provided guidance and mentorship to junior
									developers, ensuring their smooth integration
									into the team and enhancing overall project
									efficiency
								</li>
								<li>
									Developed reusable components, empowering content
									authors to effortlessly create intricate pages
									with minimal technical expertise
								</li>
								<li>
									Translated design mockups into fully functional
									web interfaces, adhering closely to project
									specifications
								</li>
								<li>
									Implemented the BEM front-end methodology,
									optimizing code reusability, maintainability, and
									comprehensibility
								</li>
								<li>
									Refactored legacy MVC code to .NET Core,
									enhancing code modularity and enabling seamless
									integration with modern web technologies
								</li>
								<li>
									Designed and implemented automations and
									streamlined processes, significantly reducing
									content creation time within the CMS
								</li>
							</ul>,
						]}
					/>{" "}
						...
						desc={[
							...
							<ul>
								<li>
									...
									meetings and presentation of demos, ensuring a
									complete understanding of business needs
								</li>
								<li>
									Designed and developed a new company website,
									increasing the effectiveness of the client's
									online presence
								</li>
								<li>
									Deployed code to a remote server using cPanel,
									simplifying the administration process for the
									clients
								</li>
								<li>
									Transferred ownership of website to the client,
									by training them in web technologies, eliminating
									dependence on third-party contractors.
								</li>
								<li>
									Applied SEO, accessibility and responsive design
									best practices, providing all users with an
					...
					<Card
						...
						desc={[
							...
							<ul>
								<li>
									Built tools and streamlined processes allowing
									business units to update website content without
									contacting IT, reducing long term operational
									costs
								</li>

								<li>
									Constructed page templates compliant with the
									WCAG level AA guidelines, improving content
									accessibility
								</li>
								<li>
									Implemented SEO best practices and techniques
									using Google Analytics, increasing the
									discoverability of information
								</li>
								<li>
									Utilized Bootstrap to execute a "mobile-first"
									design strategy, enabling a seamless browsing
									experience on a device of any size{" "}
								</li>
							</ul>,
						]}
					/>{" "}
				...
				<div className="container text-center py-7">
					...
					<Card
						...
						desc={[
							...
							<p>
								I studied the software development lifecycle, and
								software engineering best practices. During my time
								at Western I gained experience with many aspects of
								software development including UML diagrams, software
								development methodologies, relational databases and
			...
			<div id="projects" className="section">
				<div className="container text-center py-7">
					...
					<Card
						...
						desc={[
							<p>
								Rebuilt Lambton College's website on a new CMS, with
					...
					<Card
						...
						desc={[
							<p>
								A modern pokédex web app, built with Next.Js, React
								and hosted on Vercel.
							</p>,
						]}
						badges={["Next.JS", "React", "PWA", "Bootstrap", "Vercel"]}
					/>
					<Card
						src="/img/ADS_favicon.png"
						...
						desc={[
							<p>
								Designed, developed and deployed the new ADS company
								website.
							</p>,
						]}
						badges={[
					...
					<Card
						...
						desc={[
							<p>
								Refreshed the Chatham-Kent website, breathing life
								into the municipality's online presense.
							</p>,
						]}
						badges={[
							"Sharepoint",
					...
					<Card
						...
						alt="Western Mustangs Logo"
						desc={[<p>A website built for the UWO fencing team.</p>]}
					...
					<Card
						...
						desc={[
							<p>
								An online physiotherapy solution, designed and built
								in a team of 5. Employed an Agile development
								methodology to produce many protoypes, allowing for
					...
					<Card
						...
						desc={[
							<p>
								Developed and deployed a VM monitoring portal, and
								hosted on three microsoft azure virtual machines.
							</p>,
						]}
						badges={[
							"Javasript",
					...
					<Card
						...
						desc={[
							<p>
								Developed a ray tracing engine, using linear algebra
								and lighting models to color a scene with shadows,
